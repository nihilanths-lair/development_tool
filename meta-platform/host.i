...
# 3 "computing_module/driv3r.c" 2
# 11 "computing_module/driv3r.c"
...
void driv3r()
{
    ...
    m64[1] = (uint64_t) "computing_module/meta_language";
    ...
    __1:
    {
        printf(" m64[0] = %llu", m64[0]); printf(" m64[1] = %llu", m64[1]); printf(" m64[2] = %llu", m64[2]); printf(" m64[3] = %llu", m64[3]); printf(" m64[4] = %llu", m64[4]);;
    ...
    __3:
    {
        printf("\n logical opcode: 3 | MOV MEM64 <- IMM64 ; Перемещение");
        m64[pc+1] = pc+2;
        pc += 3;
        goto *opcodes[m8[pc]];
    }
...
# 2 "host.c" 2
# 1 "compiler/frontend/parser.c" 1
void parser()
{
